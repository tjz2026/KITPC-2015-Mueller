...
class Grid(object):
    ...
    def __init__(self,box,boxshape,grid_param=None):
        ...
        self.__create_kspace_grid() 


    def __create_kspace_grid(self):
        '''
